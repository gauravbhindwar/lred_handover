...
const rolePermissionMiddleware = (feature: FeaturesNameEnum, permission: PermissionEnum): RequestHandler => {
	return async (req, res, next) => {
		...
		if (result) {
			...
			return generalResponse(req, res, [], 'Access denied', 'error', false, 403);
		}
	};
};
