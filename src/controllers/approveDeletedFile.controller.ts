...
class ApproveDeletedFileController {
	...
	public deleteApproveDeletedFile = catchAsync(async (req: Request, res: Response) => {
		const responseData = await this.ApproveDeletedFileService.deleteApproveDeletedFileService(req.query);
	...
	public restoreApproveDeletedFile = catchAsync(async (req: Request, res: Response) => {
		const responseData = await this.ApproveDeletedFileService.restoreApproveDeletedFileService(req.query);
