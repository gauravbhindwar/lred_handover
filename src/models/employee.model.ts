import { EmployeeAttributes, employeeStatus } from '@/interfaces/model/employee.interface';
...
export default class Employee extends Model<EmployeeAttributes> implements EmployeeAttributes {
	@Column({
		primaryKey: true,
		autoIncrement: true,
		allowNull: true,
