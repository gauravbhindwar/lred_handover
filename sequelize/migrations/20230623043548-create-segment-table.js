    ...
    await queryInterface.sequelize.transaction(async (t) => {
      await queryInterface.createTable(
        'segment',
        {
          ...
          contactId: { type: Sequelize.INTEGER, allowNull: true },
          ...
          vatRate: { type: Sequelize.INTEGER, allowNull: true },
          xeroFormat: { type: Sequelize.INTEGER, allowNull: true },
      ...
      await queryInterface.addConstraint('segment', {
        type: 'foreign key',
        name: 'segment_client_id_fk',
        fields: ['clientId'],
        references: {
          table: 'client',
          field: 'id',
